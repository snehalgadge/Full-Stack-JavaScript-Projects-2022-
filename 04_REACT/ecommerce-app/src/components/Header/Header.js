  ...
  return (
    <div className='font-bodyFont'>
        <div className='w-full bg-amazon_blue text-white px-4 py-3 flex items-center gap-4' >
            ...
            {/* <------------Signin Start here ----------->  */}
            <div className='flex flex-col items-start justify-center px-2 h-[80%] 
            border border-transparent hover:border-white cursor-pointer duration-100'>
            ...
            {/* <------------Order Start here ----------->  */}
            <div className='flex flex-col items-start justify-center px-2 h-[100%] 
            border border-transparent hover:border-white cursor-pointer duration-100'>
            ...
            {/* <------------Cart Start here ----------->  */}
            <div className='flex items-start justify-center px-2 h-[80%] 
            border border-transparent hover:border-white cursor-pointer duration-100 relative'>
