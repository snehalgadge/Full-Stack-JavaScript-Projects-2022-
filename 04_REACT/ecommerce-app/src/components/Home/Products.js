...
const Products = () => {
  ...
  return (
    <div className="max-w-screen-2xl mx-auto grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 xl:gap-10 place-items-center px-4">
            ...
            <div>
              ...
              <div>
                <button
                  ...
                  className="w-full font-medium text-base bg-gradient-to-tr from-yellow-400 to yellow-500 border hover:from-yellow-300 hover:to-yellow-600 active:from-yellow-400 active:to-yellow-500 duration-200 py-1.5 rounded-md mt-3"
                >
                  Add to Cart
                </button>
              </div>
