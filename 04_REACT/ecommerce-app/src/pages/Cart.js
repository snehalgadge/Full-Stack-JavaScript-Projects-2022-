      ...
      {products.length > 0 ? (
        <div className="container mx-auto h-auto grid grid-cols-5 gap-8">
          <div className="w-full h-auto bg-white px-4 col-span-4">
            ...
            <div>
              {products.map((item) => (
                <div
                  className="w-full border-b-[1px] border-b-gray-300 p-4 flex
                            items-center gap-6"
                >
            ...
            <div className="w-full h-auto py-2">
              <button
                ...
                className="bg-red-500 w-36 py-2 rounded-lg text-white mt-2
          ...
          <div
            className="w-full h-52 bg-white col-span-1 flex flex-col 
            items-center p-4"
          >
            <div>
        ...
        >
          ...
          <div className="w-96 p-4 bg-white flex flex-col items-center rounded-md">
            <h1 className="font-bodyFont text-xl font-bold">
              Your Cart feels lonely.
            </h1>
            <p className="text-sm text-center">
              {' '}
              Give it purpose- fill it with books, electornics, videos, etc. and
              make it happy.
            </p>
            <Link to="/">
              <button
                className="mt-6 text-lg bg-gradient-to-tr 
              from-yellow-400 to yellow-500 border hover:from-yellow-300 hover:to-yellow-600
